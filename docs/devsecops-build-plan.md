...
| SR-1.9  | **Rate limits** (Valkey):<br>• Auth endpoints: 10 per minute per IP and 5 per minute per account identifier.<br>• Watch mutations: 30 per minute per user.<br>• Public catalog: 120 per minute per IP.                                                                                                                                                                                                                                  |
